...
public class fullscreenimage_fragment extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null && bundle.getStringArrayListExtra("img").size()>0) {
            ArrayList<String> images = bundle.getStringArrayListExtra("img");
            ImageAdapter ia = new ImageAdapter(this);
            images.remove(0);
            ia.IMAGE_URLS = images.toArray(new String[images.size()]);
            pager.setAdapter(ia);
